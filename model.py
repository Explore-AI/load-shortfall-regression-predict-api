...
def _preprocess_data(data):
    ...
    feature_vector_df = feature_vector_df[['Madrid_wind_speed', 'Bilbao_rain_1h', 'Valencia_wind_speed',
    ...
    #feature_vector_df.fillna(feature_vector_df.groupby(feature_vector_df.index.month).transform('mean'), inplace = True)
    predict_vector = feature_vector_df.astype('int64')
