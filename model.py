...
def _preprocess_data(data):
    ...
    feature_vector_df['Valencia_pressure'] = feature_vector_df['Valencia_pressure'].fillna(feature_vector_df['Valencia_pressure'].median(), inplace=True) #Manually added mean
